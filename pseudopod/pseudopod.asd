...
(asdf:defsystem "pseudopod/test"
  ...
  :components
   ((:file "test/suite")
    (:file "test/provider-protocol-test")
   ...
   (:file "test/notebook-test")
   (:file "test/run-command-test")
   (:file "test/search-backend-test")
   (:file "test/fetch-engine-test")
   (:file "test/provider-integration-test")
   (:file "test/smoke-consolidation-test")
   (:file "test/content-part-coercion-test")
   (:file "test/http-error-dispatch-test"))
