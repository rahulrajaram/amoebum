...
(asdf:defsystem "ptui/tests"
  ...
  ((:file "test/theme-test")
   ...
   (:file "test/loop-step-dispatch-test")
   (:file "test/loop-step-transition-rules-test")
   (:file "test/ansi-dispatch-test")
   (:file "test/widget-status-dispatch-test")
   (:file "test/lower-dispatch-test")
   (:file "test/terminal-diversity-test")))
