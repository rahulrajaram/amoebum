    ...
    (unwind-protect
        (progn
          (multiple-value-bind (handledp start-result)
            ...
            (is-true handledp)
            (is-true (typep start-result 'amoebum:slash-command-result))
          ...
          (multiple-value-bind (handledp stop-result)
            ...
            (is-true handledp)
            (is-true (typep stop-result 'amoebum:slash-command-result))
          ...
          (multiple-value-bind (handledp report-result)
            ...
            (is-true handledp)
            (is-true (typep report-result 'amoebum:slash-command-result))
            (let ((output (amoebum:slash-command-result-output report-result)))
              (is (stringp output))
