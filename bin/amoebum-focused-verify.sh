...
verify_ui() {
  ...
  PROFILE_NAME=ui run_focused_suites "STREAMING-STEP-SUITE,STREAM-COMPLETION-ORDERING-SUITE,EVENT-JOURNAL-DIAGNOSTICS-SUITE,INCREMENTAL-MARKDOWN-SUITE,CHAT-SNAPSHOT-SUITE,APPROVAL-DIALOG-GUARD-SUITE,KEYBOARD-NAV-SUITE,REPL-PANEL-STATE-SUITE" 1800 1800 300
